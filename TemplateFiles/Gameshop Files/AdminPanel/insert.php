...
$productID= intval($row["PRODUCT_ID"])+1;
...
?>
	<form action="OnInsert.php" method="post">
		<!-- ============================== Fieldset 1 ============================== -->
		<fieldset>
			<legend>Game Information</legend>
			<label for="input-one" class="float"><strong>PRODUCT ID:</strong></label><br />
				<input class="inp-text" name="productID" id="input-one" type="text" size="30" value="<?php echo $productID?>" /><br />
				
				<label for="input-one" class="float"><strong>GAME_NAME:</strong></label><br />
				<input class="inp-text" name="GAME_NAME" id="input-one" type="text" size="30" /><br />

				<label for="input-two" class="float"><strong>DEVELOPER:</strong></label><br />
				<input class="inp-text" name="DEVELOPER"  id="input-two" type="text" size="30" />
				
				<label for="input-two" class="float"><strong>MANUFACTURE:</strong></label><br />
				<input class="inp-text" name="MANUFACTURE"  id="input-two" type="text" size="30" />
				
				<label for="input-two" class="float"><strong>PRODUCT RATING:</strong></label><br />
				<input class="inp-text" name="PRODUCT_RATING"  id="input-two" type="text" size="30" />
		</fieldset>
		<!-- ============================== Fieldset 1 end ============================== -->
		...
		<fieldset>
			<legend>Product Details:</legend>
				...
				<input class="inp-text" name="PRICE" id="input-one" type="text" size="30"  /><br />

				<label for="input-two" class="float"><strong>RELEASE DATE:</strong></label><br />
				<input class="inp-text" name="RELEASEDATE"  id="input-two" type="text" size="30" /> 	
				
				<label for="input-two" class="float"><strong>STOCK IN STORE:</strong></label><br />
				<input class="inp-text" name="STOCKINSTORE"  id="input-two" type="text" size="30" "/>
				
				<label for="input-two" class="float"><strong>Game Image Link:</strong></label><br />
				<input class="inp-text" name="GAME_IMAGE"  id="input-two" type="text" size="30" "/>
		</fieldset>
		<!-- ============================== Fieldset 2 end ============================== -->
		...
		<p><input class="submit-button" type="submit" alt="SUBMIT" name="Submit" value="INSERT" /></p>
	</form>
	</center>
