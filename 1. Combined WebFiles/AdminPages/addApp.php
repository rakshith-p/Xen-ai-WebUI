			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<div class="card">
							<div class="header">
								<h4 class="title">Add Application Profile</h4>
							</div>
							<div class="content">
								<form action='onAppAdd.php' method="post">
									<div class="row">
										...
										<div class="col-md-8">
											<div class="form-group">
												<label>Application Log Source</label>
												<input type="text" class="form-control" placeholder="appLogSrc" name = 'appLogSrc'>
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label>Application Desciption</label>
												<textarea rows="5" class="form-control" placeholder="Application description" name="appDesc"></textarea>
											</div>
										</div>
									</div>
									...
									<button type="submit" name='insert' class="btn btn-info btn-fill pull-right" >Add Application</button>
